            ...
            <div class="flex-shrink-0 lg:flex-1 lg:min-h-0 flex flex-col border-r border-brand-border bg-white">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 border-b border-brand-border bg-stone-50/50 flex-shrink-0">
                    <div class="p-6 border-r border-brand-border">
                        ...
                        <p class="text-2xl font-black text-stone-900"><AnimatedNumber :value="summary.lines_count" /></p>
                    </div>
                    <div class="p-6 border-r border-brand-border">
                        <span class="block text-[9px] uppercase font-black text-stone-600 mb-1">Items verkocht</span>
                        <p class="text-2xl font-black text-stone-900"><AnimatedNumber :value="summary.items_count" /></p>
                    </div>
                    <div class="p-6 border-r border-brand-border">
                        <span class="block text-[9px] uppercase font-black text-stone-600 mb-1">Totaal (incl. BTW)</span>
                        <p class="text-2xl font-black text-brand-red"><AnimatedNumber :value="Number(summary.gross_total)" :decimals="2" prefix="€ " /></p>
                    </div>
                    <div class="p-6">
                        <span class="block text-[9px] uppercase font-black text-stone-600 mb-1">Totaal (excl. BTW)</span>
                        <p class="text-2xl font-black text-stone-900"><AnimatedNumber :value="Number(summary.total)" :decimals="2" prefix="€ " /></p>
                    </div>
                </div>
